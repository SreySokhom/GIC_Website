...
import 'package:gic_website/screens/FAQs/FAQsScreen.dart';
import 'package:gic_website/screens/Partner/PartnersScreen.dart';
...
class _HomeState extends State<Home> {
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ViewDetailScreen(url: "https://gic.itc.edu.kh/scholarships", header: "Scholarships",))
                            );
                          },
                          child: Align(
  ...
  _onPartnersClicked(){
    String url = "https://gic.itc.edu.kh/partners/Company";
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ViewDetailScreen(url: url)
        )
    );
  }
